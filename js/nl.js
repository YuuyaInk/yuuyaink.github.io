...
function initBackgroundAudio() {
    ...
    if ($audio.length) {
        ...
        console.warn('Deprecated background audio from Yuya JS init options. Please, use `data-audio` block on the page.');
